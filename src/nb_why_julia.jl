...
md"""
## Packages
Packages are loaded using the "using" operation. 

Note: All Julia packages should follow a camel naming scheme by convention, e.g. "DataFrames".

As an example let's load the XKCD package:
"""
...
md"""
## Unicode
You can use Unicode in Julia!! This means instead of writing pi or alpha as variables you can have the actual signs like π or α.

Usage: Mostly e.g. \alpha; more specialized characters need \:teapot: (🫖). Usually, if you hit tab after \ you get autocomplete options. 

Try it out for yourself in the next cell. 🐙
"""
...
md"""
## Functions
In Julia, like in any other language, you can define functions. 
"""
...
md"""
And now to one of Julia's strengths: Because of Julia's type system we can have multiple functions with the same name, but different methods.
"""
...
md"""
## (Beautiful) Makie
You can do fast and really beautiful plotting! (All examples copy pasted from [Beautiful Makie](beautiful.makie.org))
"""
...
# ╔═╡ d418f4af-89d2-47f1-86d4-1c7c3b174756
md"""
Init some functions:
"""

# ╔═╡ e4eae1ad-47a7-47fc-bba8-3cfa6064f212
...
# ╔═╡ b0bcf59b-3ab8-49c1-b662-620dbc274ab7
